        ...
        return (
            ...
            >
                ...
                <p className="text-accent/50 text-sm leading-relaxed max-w-sm mx-auto mb-4">
                    Thank you, {name}. A member of our team will call you shortly on your phone to confirm your booking. We look forward to welcoming you.
                </p>
                    ...
                    >
                        ...
                        {currentStep === 5 && (
                            <div className="text-center">
                                ...
                                <p className="text-accent/50 text-sm mb-8">Review your details and submit your request</p>
                                ...
                                <button
                                    ...
                                    className={`bg-primary text-dark px-10 py-5 rounded-full font-black uppercase tracking-[0.2em] text-[11px] transition-all transform flex items-center justify-center mx-auto ${
                                        isSubmitting
                                            ? 'opacity-80 cursor-not-allowed'
                                            : 'hover:bg-white hover:-translate-y-0.5 shadow-[0_0_20px_rgba(197,160,89,0.25)] shimmer'
                                    }`}
                                >
                                    {isSubmitting ? (
                                        <>
